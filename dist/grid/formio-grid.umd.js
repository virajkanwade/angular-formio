(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('rxjs'), require('formiojs'), require('lodash'), require('ngx-bootstrap/pagination')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', 'rxjs', 'formiojs', 'lodash', 'ngx-bootstrap/pagination'], factory) :
	(factory((global['formio-grid'] = {}),global.core,global.common,global.forms,global.rxjs,global.formiojs,global.lodash,global.pagination));
}(this, (function (exports,core,common,forms,rxjs,formiojs,lodash,pagination) { 'use strict';
